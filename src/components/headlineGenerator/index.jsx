...
const HeadlineGenerator = () => {
    const moduleName = "Headline generator";
    ...
    const TabBar = ({ tabIndex }) => {
        return <div className="tab">
            <div className={`tab-button${tabIndex === 0 ? " active" : ""}`} onClick={() => changeTab(0)}>
            ...
            <div className={`tab-button${tabIndex === 1 ? " active" : ""}`} onClick={() => changeTab(1)}>
    ...
    const CustomizeBtns = () => {
        return (
            <div className="btns">
                <Button className="btn customize-btn">Sample content</Button>
                <Button className="btn customize-btn primary-btn" type="primary">See results</Button>
            </div>
        )
    }
    ...
    return (
        <>
            <span className="module-name font-normal align-center">{moduleName}</span>
            <div className="title font-normal align-center">{title}​</div>
            ...
            <div className="sub-title font-normal">{subTitle}</div>
